...
open my $single_denoms_file, '>', "single_denominators.txt";
close $single_denoms_file;
my @taxa_names;
...
for my $j (1..$chromosome_number) { #Print k_chr denominators-- sum of denominators for all chromosomes except the one in question
