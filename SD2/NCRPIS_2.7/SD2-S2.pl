...
#STRUCTURE
#SD2/NCRPIS_2.7/
#├── SD2-S2.pl #script to execute COMPILE
...
my $bjh_alpha = 0.05; #Significance threshold for BJH FDR p-val
my $bonf_alpha = 0.05; #Significance threshold for Bonferroni alpha
my $p_annotate = 0.00001; #Significance threshold to annotate markers anyway
...
myGAPIT <- GAPIT(Y=myY, GD=myGD,GM=myGM, KI=myKI, group.from=2853, group.to=2853, Geno.View.output=FALSE)
q()
`;	
	close $rfile;
